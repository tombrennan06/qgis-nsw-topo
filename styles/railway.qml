...
<qgis hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" simplifyDrawingTol="1" symbologyReferenceScale="-1" minScale="100000000" styleCategories="Symbology|Labeling|Rendering" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingHints="1" version="3.34.0-Prizren" maxScale="0" labelsEnabled="0">
  <renderer-v2 referencescale="-1" symbollevels="0" type="RuleRenderer" forceraster="0" enableorderby="0">
    <rules key="{92cb5c78-3749-43d4-b9b3-4f209f2a00d8}">
      <rule filter="&quot;classsubtype&quot; IN ('HeavyRail','HeavyRailSiding')" symbol="0" key="{7cc8dff3-56fb-4ad8-bd9b-1e5b0a737b5b}" label="Heavy Rail"/>
      <rule filter="&quot;classsubtype&quot; = 'LightRail'" symbol="1" key="{42954380-e434-4c53-b12f-348240fd032a}" label="Light Rail"/>
    </rules>
    <symbols>
      <symbol name="0" clip_to_extent="1" frame_rate="10" force_rhr="0" type="line" alpha="1" is_animated="0">
        ...
        <layer enabled="1" class="SimpleLine" locked="1" pass="0" id="{b6836707-298e-42ea-a972-890f47333b6d}">
          <Option type="Map">
        ...
        <layer enabled="1" class="MarkerLine" locked="0" pass="0" id="{d09e89c2-adf3-418d-8dcd-afafeccf88f9}">
          <Option type="Map">
          ...
          <symbol name="@0@1" clip_to_extent="1" frame_rate="10" force_rhr="0" type="marker" alpha="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
            ...
            <layer enabled="1" class="SimpleMarker" locked="0" pass="0" id="{03d78710-1771-4a5c-9f21-d73cd1a464a7}">
              <Option type="Map">
      ...
      <symbol name="1" clip_to_extent="1" frame_rate="10" force_rhr="0" type="line" alpha="1" is_animated="0">
        ...
        <layer enabled="1" class="MarkerLine" locked="0" pass="0" id="{d09e89c2-adf3-418d-8dcd-afafeccf88f9}">
          ...
          <symbol name="@1@1" clip_to_extent="1" frame_rate="10" force_rhr="0" type="marker" alpha="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol name="" clip_to_extent="1" frame_rate="10" force_rhr="0" type="line" alpha="1" is_animated="0">
        ...
        <layer enabled="1" class="SimpleLine" locked="0" pass="0" id="{a62d35d4-64b6-4166-8b7d-67cceec5fb7b}">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
