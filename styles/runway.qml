...
<qgis simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" simplifyDrawingTol="1" version="3.22.10-Białowieża" hasScaleBasedVisibilityFlag="0" maxScale="0" minScale="100000000" styleCategories="Symbology|Labeling|Rendering" simplifyDrawingHints="1" simplifyMaxScale="1" labelsEnabled="0">
  <renderer-v2 enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1" symbollevels="0">
    <rules key="{f0dbee4f-d0f2-4685-8140-8dfca954464f}">
      <rule symbol="0" label="Runway Perimeter" filter=" &quot;runwaydefinition&quot; = 'RunwayPerimeter'" key="{341263a6-f7a1-4c78-9d7a-e0a741de00e9}"/>
      <rule symbol="1" label="Runway Centreline" filter=" &quot;runwaydefinition&quot; = 'RunwayCentreline'" key="{341263a6-f7a1-4c78-9d7a-e0a741de00e9}"/>
      <rule symbol="2" label="Landing Ground" filter=" &quot;runwaydefinition&quot; = 'LandingGround'" key="{6d2de478-beb1-4741-b91a-9b0dbe3d4cdf}"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" type="line" clip_to_extent="1" name="0" alpha="1">
        ...
        <layer pass="0" enabled="1" class="SimpleLine" locked="0">
          <Option type="Map">
            ...
            <Option type="QString" value="0.8;0.2" name="customdash"/>
      ...
      <symbol force_rhr="0" type="line" clip_to_extent="1" name="2" alpha="1">
        ...
        <layer pass="0" enabled="1" class="SimpleLine" locked="0">
          <Option type="Map">
            ...
            <Option type="QString" value="0" name="draw_inside_polygon"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="168,168,168,255" name="line_color"/>
            <Option type="QString" value="solid" name="line_style"/>
            <Option type="QString" value="0.7" name="line_width"/>
            <Option type="QString" value="MM" name="line_width_unit"/>
            <Option type="QString" value="0" name="offset"/>
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="168,168,168,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.7"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
